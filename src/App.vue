            ...
            <div class="ctn-block">
                <div class="footer-links-row">
                    ...
                    <div class="footer-links">
                        ...
                        <a :href="systemConfiguration.github.projectIssueUrl" target="_blank" class="links-item">{{$t('menu.links.issue_tracker')}}<svg width="13.5" height="13.5" aria-hidden="true" viewBox="0 0 24 24" class="iconExternalLink_3J9K"><path fill="currentColor" d="M21 13v10h-21v-19h12v2h-10v15h17v-8h2zm3-12h-10.988l4.035 4-6.977 7.07 2.828 2.828 6.977-7.07 4.125 4.172v-11z"></path></svg></a>
                        <a :href="systemConfiguration.github.projectPrUrl"  target="_blank" class="links-item">{{$t('menu.links.pull_requests')}}<svg width="13.5" height="13.5" aria-hidden="true" viewBox="0 0 24 24" class="iconExternalLink_3J9K"><path fill="currentColor" d="M21 13v10h-21v-19h12v2h-10v15h17v-8h2zm3-12h-10.988l4.035 4-6.977 7.07 2.828 2.828 6.977-7.07 4.125 4.172v-11z"></path></svg></a>
                    </div>
                    <div class="footer-links">
