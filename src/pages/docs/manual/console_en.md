...
> ![](/src/assets/docs/manual/global_history_interface.png)
...
> ![./media/image2.png](/src/assets/docs/manual/global_history_query_button.png)


> ![./media/image3.png](/src/assets/docs/manual/task_execution_log_of_a_single_task.png)
...
> ![./media/image4.png](/src/assets/docs/manual/administrator_view.png)
...
> ![./media/image5.png](/src/assets/docs/manual/resource_management_interface.png)
...
> ![./media/image6.png](/src/assets/docs/manual/parameter_configuration_interface.png)
...
> ![./media/image7.png](/src/assets/docs/manual/edit_directory.png)


> ![./media/image8.png](/src/assets/docs/manual/new_application_type.png)
...
> ![./media/image9.png](/src/assets/docs/manual/global_variable_interface.png)
...
> ![./media/image10.png](/src/assets/docs/manual/ECM_management_interface.png)
...
> ![./media/image11.png](/src/assets/docs/manual/ECM_editing_interface.png)


> Click the instance name of the ECM to view all engine information under the ECM.

> ![](/src/assets/docs/manual/click_the_instance_name_to_view_engine_information.png)

> ![](/src/assets/docs/manual/ECM_all_engine_information.png)
...
> ![](/src/assets/docs/manual/microservice_management_interface.png)

> ![](/src/assets/docs/manual/eureka_registration_center.png)
