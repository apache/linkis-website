...
![Linkis0.X Service List](/src/assets/docs/architecture/Linkis0.X_services_list.png)  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The list of Linkis1.0 microservices is as follows:  
![Linkis1.0 Service List](/src/assets/docs/architecture/Linkis1.0_services_list.png)  
...
![Linkis0.X How to implement a brand new engine](/src/assets/docs/architecture/Linkis0.X_newengine_architecture.png)  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The following is Linkis 1.0.0, which implements a new engine, the interfaces and classes that users need to implement:  
![Linkis1.0 How to implement a brand new engine](/src/assets/docs/architecture/Linkis1.0_newengine_architecture.png)  
...
![Linkis Engine start process](/src/assets/docs/architecture/Linkis1.0_newengine_initialization.png)  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;As shown below:  
![Linkis EngineConn Architecture diagram](/src/assets/docs/architecture/Linkis1.0_engineconn_architecture.png)
