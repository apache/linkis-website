       ...
       <div className="ctn-block">
         <div className="banner text-center">
           ...
           <div className="botton-row center">
              {
                 language === 'en' &&  <a href="/docs/latest/about/introduction" className="corner-botton blue-fill">{dataSource.common.getStart}</a>
              }
              {
                 language === 'zh-CN' &&<a href="/zh-CN/docs/latest/about/introduction" className="corner-botton blue-fill">{dataSource.common.getStart}</a>
              }
