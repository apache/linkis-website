...
1. Download the web installation package from the release page of Linkis ([click here to enter the download page](https://linkis.staged.apache.org/download/main/)), apache-linkis-xxx-incubating-web-bin. tar.gz
