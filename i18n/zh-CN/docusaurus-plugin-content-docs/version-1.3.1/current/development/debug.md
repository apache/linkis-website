...
```json
{
    ...
    "data": {
        "taskID": 1,
        "execID": "exec_id018017linkis-cg-entrance121.1.0.0:8888:8888IDE_leojie_shell_0"
    }
}
```
...
GET http://127.0.0.1:9001/api/rest_j/v1/entrance/exec_id018017linkis-cg-entrance121.1.0.0:8888IDE_leojie_shell_0/progress

```json
{
    "method": "/api/entrance/exec_id018017linkis-cg-entrance121.1.0.0:8888IDE_leojie_shell_0/progress",
    "status": 0,
    "message": "OK",
    "data": {
        "progress": 1,
